const imports = {
    env: {
        sendProgress: function (i, hash, mobile) {
            postMessage({i:i, hash:copyCStr(Module, hash), mobile:copyCStr(Module, mobile)});
        },
        printToJS: function(log) {
            console.log(copyCStr(Module, log));
        },
...
fetchAndInstantiate("mm.wasm", imports)
    .then(mod => {
        Module.alloc = mod.exports.alloc;
        Module.dealloc = mod.exports.dealloc;
        Module.dealloc_str = mod.exports.dealloc_str;
        Module.validate = mod.exports.validate;
        Module.decode = mod.exports.decode;
